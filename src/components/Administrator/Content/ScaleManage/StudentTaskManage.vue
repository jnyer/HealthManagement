...
export default {
  ...
  setup(){
    ...
    const columns = [
      ...
      {
        title: '开放时间段',
        dataIndex: 'kaifangshijianduan',
        key: 'kaifangshijianduan',
        align: 'center',
      },{
        title: '开放年级',
        dataIndex: 'kaifangnianji',
        key: 'kaifangnianji',
        align: 'center',
      },{
        title: '使用量表',
